 ...
 *
 */
public class M2imageSave extends View {

	Paint mPaint; //画笔,包含了画几何图形、文本等的样式和颜色信息
	public M2imageSave(Context context) {
		super(context);

	}

	public M2imageSave(Context context, AttributeSet attrs){
		super(context, attrs);
		mPaint = new Paint();
	...
	public void onDraw(Canvas canvas){
		...
		canvas.drawRect(60, 10, 200, 100, mPaint); //绘制矩形
